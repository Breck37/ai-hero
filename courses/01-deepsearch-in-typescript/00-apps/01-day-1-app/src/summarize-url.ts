...
Please create a detailed synthesis focusing on information relevant to the research topic.`,
    ...
    console.error("Error summarizing URL:", {
      url: searchMetadata.url,
      error,
      langfuseTraceId,
    });
...
// Cache summaries for 6 hours using Redis
export const summarizeURL = cacheWithRedis("url_summary", _summarizeURL);
